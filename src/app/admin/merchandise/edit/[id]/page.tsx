...
export default function EditProduct() {
  ...
  useEffect(() => {
    if (profile?.user_role === 'admin' && productId) {
      fetchProduct();
    }
  }, [profile, productId]);
    ...
    try {
      ...
      if (data) {
        setForm({
          ...
          badge_border_color: data.badge_border_color || '#999999',
  ...
  if (fetching) {
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="text-center">
          <div className="text-gothic-steel">Loading product details...</div>
        </div>
      </div>
    );
  }
        ...
        >
          ...
          <div>
            ...
            <p className="text-gothic-steel mt-2">
              Update product details for the Black Ledger Goods marketplace
            </p>
          </div>
        </motion.div>
