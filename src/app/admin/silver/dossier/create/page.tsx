    ...
    return (
      <div className="min-h-screen bg-gothic-black">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="bg-gothic-charcoal border border-gothic-silver/20 rounded-lg overflow-hidden">
            {formData.image_url && (
            ...
            <div className="p-8">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-gothic-silver text-sm capitalize">{formData.type}</span>
              </div>
              <h1 className="text-3xl font-bold text-gothic-silver mb-4">{formData.title}</h1>
              <p className="text-gothic-silver/80 mb-6">{formData.summary}</p>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-3xl font-bold text-gothic-silver">Create Dossier Entry</h1>
            </div>
        ...
        >
          ...
          <div className="mb-6">
            ...
            />
            {formData.image_url && (
              <div className="mt-3 bg-gothic-black/50 p-4 rounded border border-gothic-silver/30">
                <img 
                  src={formData.image_url}
                  alt="Preview"
